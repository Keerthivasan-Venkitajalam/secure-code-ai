...
HF_TOKEN = "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" # From user's notebook
...
def download_pysecdb():
    print(f"  Downloading PySecDB from {PYSECDB_URL}...")
    try:
...
def download_cse3():
    print("  Downloading CyberSecEval (walledai) using pandas...")
    try:
        import pandas as pd
